...
public class Sql2oCandidateRepositoryTest {
    ...
    public void whenSaveSeveralThenGetAll() {
        ...
        var candidate1 = sql2oCandidateRepository.save(new Candidate(0, "name2", "description2", creationDate, 1, file.getId()));
        var candidate2 = sql2oCandidateRepository.save(new Candidate(0, "name3", "description3", creationDate, 1, file.getId()));
        var result = sql2oCandidateRepository.findAll();
        assertThat(result).isEqualTo(List.of(candidate, candidate1, candidate2));
    }
    ...
    public void whenUpdateThenGetUpdated() {
        ...
        var updatedCandidate = new Candidate(
                candidate.getId(), "new name", "new description", creationDate, 1, file.getId()
        );
